...
impl Config {
    pub fn from_args() -> Config {
        ...
        let args = App::new("Electrum Rust Server")
            ...
            .arg(
                Arg::with_name("daemon_rpc_addr")
                    ...
                    .help("BTX daemon (btxd) JSONRPC 'addr:port' to connect (default: 127.0.0.1:19334 for mainnet, 127.0.0.1:29334 for testnet3 and 127.0.0.1:48332 for testnet4 and 127.0.0.1:18443 for regtest)")
                    .takes_value(true),
            )
            .arg(
        ...
        let default_daemon_port = match network_type {
            ...
            Network::Bitcoin => 19334, // BTX btxd mainnet JSONRPC (was 8332)
            #[cfg(not(feature = "liquid"))]
            Network::Testnet => 29334, // BTX btxd testnet JSONRPC (was 18332)
            #[cfg(not(feature = "liquid"))]
            Network::Testnet4 => 48332,
            #[cfg(not(feature = "liquid"))]
            Network::Regtest => 18443, // BTX btxd regtest JSONRPC (unchanged)
            #[cfg(not(feature = "liquid"))]
